...
const App = () => {
  ...
  return(
    <div>
      <div className="mx-64 my-10 p-20 flex justify-center align-middle bg-zinc-300 rounded-xl">
        <div className="flex flex-col">
          <div className=" bg-green-400 rounded-xl">
            <div className="flex flex-row justify-evenly text-center my-4">
              ...
              <Submit changeValue={changeValue} fetchWeather={fetchWeather} value={value} />
            </div>
          </div>
