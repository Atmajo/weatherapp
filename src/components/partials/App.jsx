...
const App = () => {
  ...
  return (
    <div className="w-[360px] flex flex-col justify-center align-middle m-auto mt-20 bg-zinc-200 rounded-xl select-none">
      <div className="w-[340px] m-auto">
        <div className="flex gap-5 my-10 p-5 bg-green-300 rounded-xl">
        ...
        <div className="flex flex-col mb-5 p-5 bg-green-300 rounded-xl">
